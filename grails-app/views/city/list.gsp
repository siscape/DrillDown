			...
			<table>
				<thead>
					<tr>
						...
						<g:sortableColumn property="supplierCity" title="${message(code: 'city.supplierCity.label', default: 'Supplier City')}" />
				...
				<g:each in="${cityInstanceList}" status="i" var="cityInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td><g:link action="show" id="${cityInstance.id}">${fieldValue(bean: cityInstance, field: "supplierCity")}</g:link></td>
